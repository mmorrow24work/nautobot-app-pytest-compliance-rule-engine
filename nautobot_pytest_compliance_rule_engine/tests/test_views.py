...
class ComplianceTestResultViewTest(ViewTestCases.ListObjectsViewTestCase):
    """List-view and permission tests for the read-only ComplianceTestResult UI view.

    Only ListObjectsViewTestCase applies here -- there is no create/edit/delete UI for
